...
def sync_existing_chapters(payload: dict[str, Any], callbacks: TaskCallbacks | None = None) -> TaskResult:
    ...
    concise_log.emit_start(operation, start, end)

    results = AdapterFactory.get_syncer().run_multi_chapter_sync(
