...
from backend.adapters.fanqie_web.pages.chapter_editor_page import pick_chapter_no_title_and_editor
from backend.adapters.fanqie_web.browser.browser_session import save_debug
from backend.adapters.fanqie_web.page_actions.chapter_page_interactions import dismiss_popups, ensure_logged_in, goto_chapter_manage, wait_briefly_for_page_ready
...
from backend.adapters.fanqie_web.chapter_editor_creator import (
    _click_new_chapter,
...
def create_remote_chapter_editor(
    page: Page,
    *,
    ...
    if verify_sequence:
        ...
        log("番茄发布流程：跳过平台章节查找/对比，直接点击“新建章节”。")
