...
from backend.adapters.webnovel_writer.webnovel_writer_platform import WebnovelWriterRuntime


class WebnovelWriterClient:
    def __init__(self, runtime: WebnovelWriterRuntime) -> None:
        try:
