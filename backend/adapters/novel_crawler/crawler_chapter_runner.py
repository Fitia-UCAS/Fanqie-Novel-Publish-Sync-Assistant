...
from backend.adapters.novel_crawler.crawler_models import ChapterContent, ChapterLink, CrawlErrorType, NovelCatalog, ProgressSnapshot
from backend.adapters.novel_crawler.sites import NovelSiteAdapter
