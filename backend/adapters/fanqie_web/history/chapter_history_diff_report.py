...
from backend.shared.app.app_paths import CHAPTER_SYNC_COMPARE_DIR
from backend.services.novel_text.text_normalizer import normalize_text, normalize_novel_body
