...
from backend.adapters.novel_crawler.crawler_models import AdapterOptions, ChapterLink, NovelCatalog
...
from backend.adapters.novel_crawler.crawler_models import ChapterContent, NovelCrawlerRequest
...
def test_crawler_only_fetches_missing_chapters_and_merges_existing_txt(tmp_path: Path, monkeypatch: object) -> None:
    ...
    monkeypatch.setattr("backend.adapters.novel_crawler.crawler_service.adapter_for_url", _resume_fake_adapter_type)
...
from backend.adapters.novel_crawler.crawler_models import CrawlErrorType
...
from backend.shared.app.app_config import _merge_default
